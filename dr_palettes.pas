...
procedure DT_RawPalette2DoomPalette(const rowpal: pointer; const palette: PDoomPalette);

function DT_FindAproxColorIndex(const pal: PDoomPalette; const c: LongWord;
